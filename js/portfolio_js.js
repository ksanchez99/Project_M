...
//This function displays the first img in the slideshow when the page loads
var slideIndex = 1;
showSlides(slideIndex);

//This fucntionb changes the slides when them left or right arrorws are clicked
...
document.addEventListener("click", function(event){
    ...
    if (event.target.matches(".canel") || !event.target.closest(".form-popup") && !event.target.closest(".Pop_Up_Button") && !event.target.closest(".contact")){
        closeForm()
    }
}, false )
